...
public interface EnquantoListener extends ParseTreeListener {
	 ...
	 * labeled alternative in {@link EnquantoParser#func}.
	 * @param ctx the parse tree
	 */
	void enterFuncao(@NotNull EnquantoParser.FuncaoContext ctx);
	/**
	 * Exit a parse tree produced by the {@code funcao}
	 * labeled alternative in {@link EnquantoParser#func}.
	 * @param ctx the parse tree
	 */
	void exitFuncao(@NotNull EnquantoParser.FuncaoContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterBool(@NotNull EnquantoParser.BoolContext ctx);
	/**
	 * Exit a parse tree produced by the {@code bool}
	 * labeled alternative in {@link EnquantoParser#booleano}.
	 * @param ctx the parse tree
	 */
	void exitBool(@NotNull EnquantoParser.BoolContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterParametros(@NotNull EnquantoParser.ParametrosContext ctx);
	/**
	 * Exit a parse tree produced by {@link EnquantoParser#parametros}.
	 * @param ctx the parse tree
	 */
	void exitParametros(@NotNull EnquantoParser.ParametrosContext ctx);
	/**
